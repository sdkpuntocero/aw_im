    ...
    public partial class registro_inicial : System.Web.UI.Page
    {
        ...
        private void carga_select()
        {
            ...
            using (db_imEntities m_ss = new db_imEntities())
            {
                ...
                s_licencia.DataSource = i_ma;
                s_licencia.DataTextField = "licencia_desc";
                s_licencia.DataValueField = "licencia_ID";
                s_licencia.DataBind();

                s_licencia.Items.Insert(0, new ListItem("Licencia", string.Empty));
        ...
        private void guarda_registro()
        {
            ...
            Guid i_licencia = Guid.Parse(Request.Form["s_licencia"]);
            ...
            var d_cnt = new inf_centro
            {
                ...
                empresa_ID = guid_emp,
                est_cnt_ID = 1,
                centro_nom = t_cntn.ToTitleCase(i_cnt_nom),
                email = i_email,
                telefono = i_tel,
            ...
            using (var m_env = new db_imEntities())
            {
                ...
                string detalle_e = "Registro de Compañia, Director y Corporativo, satisfactorio.";
