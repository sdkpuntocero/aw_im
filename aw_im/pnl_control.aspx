                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-12" style="">
                                            <ul class="list-group">
                                                ...
                                                <li class=" border-0 list-group-item d-flex justify-content-between align-items-center" runat="server" id="li_vnta">
                                                    <asp:LinkButton ID="lkb_ctrl_vnta" runat="server" Text="Ventas" OnClick="lkb_ctrl_vnta_Click"></asp:LinkButton>
                                                ...
                                                <li class=" border-0 list-group-item d-flex justify-content-between align-items-center" runat="server" id="li_comp">
                                                    <asp:LinkButton ID="lkb_ctrl_compras" runat="server" Text="Compras" OnClick="lkb_ctrl_compras_Click"></asp:LinkButton>
                                                ...
                                                <li class=" border-0 list-group-item d-flex justify-content-between align-items-center" runat="server" id="li_cnt">
                                                    <asp:LinkButton ID="lkb_ctrl_centros" runat="server" Text="Centros" OnClick="lkb_ctrl_centros_Click"></asp:LinkButton>
                                                    <i class="fas fa-landmark text-danger fa-lg"></i>
                                                </li>
                            ...
                            <div class="col-md-9">
                                        ...
                                        <div class="card" runat="server" id="card_ventas" visible="false">
                                            <div class="card-header">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="i_vnta_buscar" runat="server" placeholder="Buscar Venta" TextMode="Search" TabIndex="2"></asp:TextBox>
                                            ...
                                            <div class="card-header">
                                                <div class="text-right">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <asp:TextBox CssClass="form-control" ID="i_comp_buscar" runat="server" placeholder="Buscar Compra" TextMode="Search" TabIndex="3"></asp:TextBox>
                                ...
                                <asp:UpdatePanel ID="up_centros" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="card" runat="server" id="card_centros" visible="false">
                                            <div class="card-header">
                                                <div class="text-right">
